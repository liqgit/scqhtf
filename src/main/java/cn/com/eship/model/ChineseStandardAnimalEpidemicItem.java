...
@Entity
@Table(name = "t_chinese_standard_animal_epidemic_item", schema = "tjrsms", catalog = "")
public class ChineseStandardAnimalEpidemicItem {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        ChineseStandardAnimalEpidemicItem that = (ChineseStandardAnimalEpidemicItem) o;
